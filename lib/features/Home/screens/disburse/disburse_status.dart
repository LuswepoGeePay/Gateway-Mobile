...
import 'package:gateway_mobile/features/Home/controllers/disburse_status_controller.dart';
...
class DisburseStatusScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(
      DisburseStatusController(reference: reference),
      tag: reference,
    );
    ...
    return Scaffold(
      appBar: const APPAPPBar(
        title: Text("Disbursement Status"),
        showBackArrow: true,
      ),
                  ...
                  children: [
                    ...
                    Text(
                      controller.message.value.isNotEmpty
                          ...
                          : (status == "pending"
                                ? "Your disbursement is being processed by the network."
                                : ""),
                    ...
                    if (status == "pending" &&
                        !controller.pollWindowEnded.value)
                      Padding(
              ...
              if (controller.status.value != "pending") {
                return SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      final disburseController = Get.find<DisburseController>();
                      disburseController.clearForm();
                      Get.back();
                    },
